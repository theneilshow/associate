...
class PrintersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create printer" do
    assert_difference('Printer.count') do
      post printers_url, params: { printer: { isPrinting: @printer.isPrinting, name: @printer.name } }
    end
  ...
  test "should update printer" do
    patch printer_url(@printer), params: { printer: { isPrinting: @printer.isPrinting, name: @printer.name } }
